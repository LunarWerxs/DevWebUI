...
export default {
  ...
  alerts: {
    ...
    rulesHelp:
      "Fire once a process's CPU or memory sample stays over a threshold, continuously, for a set duration - then stay quiet until it drops back under and breaches again.",
    noRules: "No alert rules yet.",
    cpu: "CPU",
    memory: "Memory",
    metric: "Metric",
    pickProcess: "Pick a process",
    thresholdLabel: "Threshold ({unit})",
    forSecondsLabel: "For (seconds)",
    for: "for",
    forDuration: "for {secs}s",
    seconds: "sec",
    add: "Add",
    remove: "Remove rule",
    added: "Alert rule added",
    addFailed: "Couldn't add the alert rule",
    removeFailed: "Couldn't remove the alert rule",
    loadFailed: "Couldn't load alert rules",
    eventsTitle: "Fired events",
    noEvents: "No fired alert events yet.",
    eventLine: "{value} {metric} exceeded {threshold} · {when}",
